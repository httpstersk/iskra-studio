...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden rounded-lg border border-border/50 bg-popover/95 backdrop-blur-xl p-1 text-popover-foreground shadow-[0_8px_32px_rgba(0,0,0,0.4)]",
