...
9. Every keyMoment beat MUST include SPECIFIC CAMERA MOTION characteristic of the chosen cinematographer: tracking shots, dolly moves, crane movements, handheld energy, Steadicam glides, push-ins, pull-outs, orbiting moves, aerial descents, etc. NO STATIC SHOTS.
...
- "keyMoments": Array of 4 ordered beats describing the sequence (string[]); each item must follow the format "Beat X (Ys-Zs): [CAMERA MOTION] description" where the camera motion is explicit and evocative (e.g., "Beat 1 (0s-1s): Rapid dolly-in as trembling hands reach for the phone", "Beat 2 (1s-2s): Sweeping crane up revealing the crowded street below").
