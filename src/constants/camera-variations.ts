...
export const CAMERA_VARIATIONS = [
  ...
  "CENTER-FRAMED SYMMETRY — PERFECTLY CENTERED COMPOSITION with balanced elements; creates formal, stylized, or Wes Anderson-esque aesthetic.",
  "CHROMATIC ABERRATION — RGB COLOR SEPARATION at edges; creates retro, glitchy, or disoriented psychological state.",
  ...
  "DRONE FLYOVER — SWEEPING AERIAL MOVEMENT passing over subject or landscape; reveals scale and layout from moving bird's eye perspective.",
  ...
  "FILM NOIR SHADOWS — VENETIAN BLIND LIGHTING or stark shadows; creates high-contrast mystery and dramatic tension.",
  ...
  "HANDHELD CHAOS — SHAKY CAMERA MOVEMENT; creates urgency, realism, panic, or documentary-style immediacy.",
  ...
  "KALEIDOSCOPE FRACTAL — MULTIPLE MIRRORED REFLECTIONS; creates abstract, psychedelic, or geometric patterns from the subject.",
  ...
  "NEGATIVE SPACE MINIMALISM — SMALL SUBJECT in vast empty frame; creates isolation, loneliness, or scale.",
  "NIGHT VISION PHOSPHOR — GREEN OR WHITE MONOCHROME with grain; creates tactical, surveillance, or horror atmosphere.",
